...
func TestBee(t *testing.T) {
    ...
    RunSpecsWithDefaultAndCustomReporters(t, "TemplateRouter Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
    ...
    defer GinkgoRecover()
    Eventually(func() interface{} { return arguments.ControllerManager.GetController("TemplateRouterController") }).
        Should(Not(BeNil()))
    ctrl = arguments.ControllerManager.GetController("TemplateRouterController")
})
